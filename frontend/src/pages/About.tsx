...
const About = () => {
    ...
    return (
        <section className="my-16 sm:h-screen h-auto w-full">

            <div className="flex flex-col py-8 sm:flex-row gap-8 items-start justify-center sm:items-center bg-black px-2">
